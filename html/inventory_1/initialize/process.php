...
delete from prof_tran;
truncate table prof_tran;
delete from prof_hd;
truncate prof_hd;
...
delete from item_group_sub;
delete from stk_tran;
delete from prod_master;
delete from prod_mast;

TRUNCATE TABLE item_group_sub;
TRUNCATE TABLE stk_tran;
TRUNCATE TABLE prod_mast;
DELETE from stk_tran;
TRUNCATE table stk_tran;

DELETE FROM price_change;
DELETE FROM supp_mast;
DELETE FROM customers_trans;
delete from invoice_tran;
truncate table invoice_tran;
delete from invoice_hd;
truncate table invoice_hd;
DELETE FROM customers;

DELETE from po_trans;
TRUNCATE table po_trans;
DELETE from po_hd;
TRUNCATE po_hd;
DELETE FROM grn_trans;
DELETE from grn_hd;
TRUNCATE table grn_trans;
TRUNCATE table  grn_hd;

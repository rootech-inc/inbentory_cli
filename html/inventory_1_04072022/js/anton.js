...
function validateSize(reload) {
    ...
    if(screen_width === 1024 && screen_height === 666)
    {
        if(reload === 'yes')
        {
            location.reload();
        ...
        var content = "<div class='bg-light w-100 vh-100 text-danger d-flex flex-wrap align-content-center justify-content-center'>" +
            "<div class='alert alert-danger'>Unsupported Screen Dimension <small>i.e <kbd>"+screen_width+"</kbd> x <kbd>"+screen_height+"</kbd></small> Not " +
            "</div>" +
            "</div>";
